...
INSERT INTO item(unit, carport_part, description, length, price_pr_unit)
VALUES ('Stk', 'Spær', '25x200 mm. trykimp. Bræt| understernbrædder til for & bag ende', 360, 100),
       ('Stk', 'Rem', '25x200 mm. trykimp. Bræt| understernbrædder til siderne', 540, 100),
       ('Stk', 'Stolpe', '97x97 mm. trykimp. stolpe', 300, 75);
